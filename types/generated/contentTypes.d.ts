...
export interface ApiCategoriaCategoria extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categoria_id: Schema.Attribute.UID &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPlantillasContratoPlantillasContrato
  extends Struct.CollectionTypeSchema {
  collectionName: 'plantillas_contratos';
  info: {
    displayName: 'PlantillasContratos';
    pluralName: 'plantillas-contratos';
    singularName: 'plantillas-contrato';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::plantillas-contrato.plantillas-contrato'
    > &
      Schema.Attribute.Private;
    Nombre: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiReservaReserva extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Confirmacion: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    contrato_firmado: Schema.Attribute.Media<'files'>;
    contrato_generado: Schema.Attribute.Media<'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documentoFirmado: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    docusignEnvelopeId: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    tour_id: Schema.Attribute.Relation<'manyToOne', 'api::tour.tour'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    duracion_min: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    no_incluye: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    precio: Schema.Attribute.Decimal &
      ...
      >;
    publishedAt: Schema.Attribute.DateTime;
    recomendaciones: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    Pasaporte: Schema.Attribute.Media<'files'>;
    passportCloudinaryPublicId: Schema.Attribute.String;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    Visa: Schema.Attribute.Media<'files'>;
    visaCloudinaryPublicId: Schema.Attribute.String;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::plantillas-contrato.plantillas-contrato': ApiPlantillasContratoPlantillasContrato;
